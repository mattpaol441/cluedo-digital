                ...
                <div className="flex items-center gap-4 bg-slate-800 px-4 py-1 rounded-full border border-slate-700">
                    ...
                    {hasRolled ? (
                        <div className="flex gap-2">
                             {/* Usiamo dei semplici div quadrati per i dadi nell'HUD */}
                        ...
                        // Placeholder quando non sono stati ancora tirati
                        ...
                        <div className="flex gap-3 items-end h-28">
                            {myPlayer.hand.map((card) => (
                                <GameCard
                                    ...
                                    size="SMALL" // Dimensione piccola per l'HUD
                                    className="hover:-translate-y-6" // Effetto "estrai carta" accentuato
                                />
                            ))}
                        </div>
                    ) : (
